...
public class NoteDatabase extends SQLiteOpenHelper {
    ...
    //veritabanı tablosu için sütun adı
    ...
    public void onCreate(SQLiteDatabase db) {
        //CREATE TABLE nametime (id TIME PRIMARY KEY, title TEXT, content TEXT, date TEXT, time TEXT);
    ...
    public Not getNote(long id){
        ...
        if (cursor != null)
            cursor.moveToFirst();
       return new Not(cursor.getLong(0),cursor.getString(1),cursor.getString(2),cursor.getString(3),cursor.getString(4));
    }

    public List<Not> getNote() {
        SQLiteDatabase db = this.getReadableDatabase();
        List<Not> allNotes = new ArrayList<>();
        ...
        if(cursor.moveToFirst()){
            do{
                ...
                not.setTitle(cursor.getString(1));
